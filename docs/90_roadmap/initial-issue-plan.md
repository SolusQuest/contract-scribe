...
M0 closed after every item above completed. Its exact accepted revision remains historical milestone evidence governed by [Contract lifecycle](../00_project/contract-lifecycle.md); M1 may complete the current pre-release v1 semantics through one coherent affected-path change without reopening M0, creating a successor baseline, or incrementing versions solely for development churn.
