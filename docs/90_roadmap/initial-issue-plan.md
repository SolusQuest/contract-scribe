...
M0.1–M0.3 inform M1 implementation planning. M0.4–M0.6 decide the execution and distribution boundary; M0.7 validates that selected baseline independently before M0 can exit. The bootstrap does not perform these tasks.
