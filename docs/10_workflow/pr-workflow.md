...
PR bodies must explain the change, link the tracking issue, record validation actually performed, and list remaining risks. A PR must not claim validation that did not run.
